import { formatDateTime, formatMoney, formatMultiplier, formatNumber, formatPercent } from './format.js';
...
export function ipoFaq(data) {
  const faq = [];
  const asOf = data.fetchedAt ? formatDateTime(data.fetchedAt) : null;
  faq.push({
